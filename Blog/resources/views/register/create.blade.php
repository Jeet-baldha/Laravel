<x-layout>
    <main class="px-6 py-8 max-w-lg mx-auto mt-10 ">
        ...
        <form method="POST" accept="/register" class="mt-10 p-6 bg-gray-100 border border-gray-200 rounded-xl ">

            @csrf

            <div class=" mb-6 ">
                <label for="name" class=" block mb-2 text-uppercase font-bold text-xs text-gray-700">
                    Name
                </label>
                <input class=" border border-gray-400 rounded-md p-2  text-xs w-full " type="text" name="name" id="name"
            ...
            <div class=" mb-6 ">
                <label for="username" class=" block mb-2 text-uppercase font-bold text-xs text-gray-700">
                    Username
                </label>
                <input class=" border border-gray-400 rounded-md p-2  text-xs w-full " type="text" name="username"
