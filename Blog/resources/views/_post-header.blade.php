    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
        ...
        <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
            ...
            <div x-data="{show:false}" class="w-32" style="dislplay:none">
                ...
                <div x-show="show" class="absolute w-full bg-gray-100 text-left mt-2 rounded-xl z-10 text-sm py-2 ">
                    <a class="block hover:bg-blue-400 focus:bg-blue-400 hover:text-white cursor-pointer px-3 py-1"
                        href="/">
                        All</a>
